          ...
          const byte interruptPIN2 = 24;//26;//24; // YELLOW RIGHT
          const byte interruptPIN3 = 25;//27;//25; // WHITE  RIGHT
          const byte interruptPIN0 = 26;//24;//26; // YELLOW LEFT
          const byte interruptPIN1 = 27;//25;//27; // WHITE  LEFT
