...
void turn_180_r_bin(int turntime);


void turn_180_l_bin(int turntime);
...
void turn_90_r(int right, int left, int time2, int time_to_turn)
{
  analogWrite (R_ME,right);
  analogWrite (L_ME,left);
  int TimeMillis = 0;
...
void turn_90_l(int right, int left, int time2, int time_to_turn)
{
  analogWrite (R_ME,right);
  analogWrite (L_ME,left);
  int TimeMillis = 0;
...
void go_to_bin()
{
  ...
  int exit = 0;
   ...
   int l = speed_L;
   speed_R = speed_R - alignement_factor;
   speed_L = speed_L - alignement_factor +2;
