...
void turn_correct()
{
  ...
  */
  ...
  if (left_sensor_state == WHITE && right_sensor_state == BLACK)
    {
      while(left_sensor_state == WHITE && right_sensor_state == BLACK)
      {
      ...
      Serial.print("\t");
       ...
       Serial.print(right_sensor_state);
        ...
        read_ir();
        if(left_sensor_state == WHITE && right_sensor_state == WHITE)
        {
    ...
    else if (left_sensor_state == BLACK && right_sensor_state == WHITE)
    {
    while(left_sensor_state == BLACK && right_sensor_state == WHITE)
    {
 ...
 Serial.println(right_arm_sensor_state);
  ...
  read_ir();
    ...
    while (exit == 0)
    {
        ...
        if (front_left_sensor_state == WHITE && front_right_sensor_state == BLACK )
        {
